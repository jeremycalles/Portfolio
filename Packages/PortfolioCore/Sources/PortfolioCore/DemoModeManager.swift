...
public class DemoModeManager: ObservableObject {
    ...
    @Published public var isDemoModeEnabled: Bool {
        didSet {
    ...
    @Published public var demoSeed: UInt64 {
        didSet {
    ...
    public func getRandomizedQuantity(forIsin isin: String, originalQuantity: Double, currentPrice: Double?) -> Double {
    ...
    public func getTotalRandomizedQuantity(forIsin isin: String, originalTotal: Double, currentPrice: Double?) -> Double {
