...
public actor MarketDataService {
    ...
    public func takeLastFetchError() -> String? {
    ...
    // MARK: - Constants
    public static let troyOunceGrams = 31.1034768
    ...
    public func fetchData(isin: String, ticker: String? = nil) async -> MarketDataResult {
        let today = AppDateFormatter.todayString
    ...
    public func resolveIsinToTicker(isin: String) async -> String? {
    ...
    public func scrapeAuCoffreHistorical(isin: String) async -> [Price] {
    ...
    // MARK: - Exchange Rate
    public func fetchExchangeRate(from fromCurrency: String, to toCurrency: String) async -> ExchangeRate? {
    ...
    public func fetchHistoricalData(isin: String, ticker: String?, period: String = "1y", interval: String = "1mo") async -> [Price] {
    ...
    public func fetchHistoricalDataForTicker(isin: String, ticker: String, period: String = "1y", interval: String = "1mo") async -> [Price] {
    ...
    public func fetchSP500History(period: String = "2y", interval: String = "1d") async -> [Price] {
    ...
    public func fetchGoldHistory(period: String = "2y", interval: String = "1d") async -> [Price] {
    ...
    public func fetchMSCIWorldHistory(period: String = "2y", interval: String = "1d") async -> [Price] {
        await fetchHistoricalPricesFromYahooChart(tickerSymbol: "URTH", isin: MSCIWorldIndexIsin, period: period, interval: interval)
    }
    
    public func fetchHistoricalRates(from fromCurrency: String, to toCurrency: String, period: String = "1y", interval: String = "1mo") async -> [ExchangeRate] {
        let pair = "\(fromCurrency)\(toCurrency)=X"
