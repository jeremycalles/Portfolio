...
public struct StorageLogEntry: Codable, Identifiable {
    public let id: UUID
    ...
    public init(message: String, isWarning: Bool = false, isError: Bool = false) {
        self.id = UUID()
        self.timestamp = Date()
...
public class DatabaseService: ObservableObject {
    ...
    public static func projectRootPath() -> String {
    ...
    @Published public private(set) var storageLogEntries: [StorageLogEntry] = []
    
    /// True when the user's iCloud container is available (for backup only; database is always local).
    public var iCloudBackupAvailable: Bool { iCloudBackupContainerURL != nil }
    ...
    public func backupDatabaseToICloud(completion: ((Swift.Result<Void, Error>) -> Void)? = nil) {
        let path = dbPath
    ...
    public func reconnectToDatabase() {
        db = nil
        connectToDatabase()
    }
    ...
    // MARK: - Instruments
    public func getAllInstruments() -> [Instrument] {
        return fetchAll(query: instruments, mapper: instrumentFromRow)
    }
    
    public func getInstrument(byIsin instrumentIsin: String) -> Instrument? {
    ...
    public func addOrUpdateInstrument(_ instrument: Instrument) {
        guard let db = db else { return }
    ...
    public func deleteInstrument(_ instrumentIsin: String) {
        guard let db = db else { return }
    ...
    public func assignQuadrant(instrumentIsin: String, quadrantId newQuadrantId: Int?) {
        guard let db = db else { return }
    ...
    // MARK: - Prices
    public func addPrice(_ price: Price) {
        guard let db = db else { return }
    ...
    public func deletePrice(isin: String, date priceDate: String) {
        guard let db = db else { return }
    ...
    public func getLatestPrice(forIsin instrumentIsin: String) -> Price? {
        guard let db = db else { return nil }
    ...
    public func getLastInstrumentUpdateDate() -> String? {
        guard let db = db else { return nil }
        do {
    ...
    public func getPrice(forIsin instrumentIsin: String, date targetDate: String) -> Price? {
        guard let db = db else { return nil }
    ...
    public func getPriceHistory(forIsin instrumentIsin: String) -> [Price] {
        return fetchAll(query: prices.filter(priceIsin == instrumentIsin).order(date.desc), mapper: priceFromRow)
    }
    
    public func getPriceOnOrBefore(forIsin instrumentIsin: String, date targetDate: String, windowDays: Int = 30) -> Price? {
        guard let db = db else { return nil }
    ...
    public func getPriceBefore(forIsin instrumentIsin: String, date targetDate: String) -> Price? {
        guard let db = db else { return nil }
    ...
    // MARK: - Exchange Rates
    public func addExchangeRate(_ exchangeRate: ExchangeRate) {
        guard let db = db else { return }
    ...
    public func getLatestRate(from: String, to: String) -> ExchangeRate? {
        guard let db = db else { return nil }
    ...
    public func getRateOnOrBefore(from: String, to: String, date targetDate: String) -> ExchangeRate? {
        guard let db = db else { return nil }
    ...
    // MARK: - Quadrants
    public func getAllQuadrants() -> [Quadrant] {
        return fetchAll(query: quadrants.order(quadName), mapper: quadrantFromRow)
    }
    
    public func addQuadrant(name quadrantName: String) -> Bool {
    ...
    public func deleteQuadrant(id quadrantIdValue: Int) {
        guard let db = db else { return }
    ...
    // MARK: - Bank Accounts
    public func getAllBankAccounts() -> [BankAccount] {
        return fetchAll(query: bankAccounts.order(bankName, accountName), mapper: bankAccountFromRow)
    }
    
    public func addBankAccount(bank: String, account: String) -> Bool {
        guard let db = db else { return false }
    ...
    public func deleteBankAccount(id accountIdValue: Int) {
        guard let db = db else { return }
    ...
    // MARK: - Holdings
    public func getHoldings(forAccount accountIdValue: Int) -> [Holding] {
    ...
    public func addOrUpdateHolding(_ holding: Holding) {
        guard let db = db else { return }
    ...
    public func updateHolding(accountIdValue: Int, instrumentIsin: String, quantity newQuantity: Double, purchaseDate newPurchaseDate: String?, purchasePrice newPurchasePrice: Double?) {
        guard let db = db else { return }
        let now = AppDateFormatter.iso8601.string(from: Date())
        do {
    ...
    public func deleteHolding(accountIdValue: Int, instrumentIsin: String) {
        guard let db = db else { return }
    ...
    public func getTotalQuantity(forIsin instrumentIsin: String) -> Double {
...
public class DatabaseService: ObservableObject {
    public static let shared = DatabaseService()
    @Published public private(set) var storageLogEntries: [StorageLogEntry] = []
    public var iCloudBackupAvailable: Bool { false }
    ...
    public func getAllInstruments() -> [Instrument] { [] }
    public func getInstrument(byIsin instrumentIsin: String) -> Instrument? { nil }
    public func addOrUpdateInstrument(_ instrument: Instrument) {}
    public func deleteInstrument(_ instrumentIsin: String) {}
    public func assignQuadrant(instrumentIsin: String, quadrantId newQuadrantId: Int?) {}
    ...
    public func addPrice(_ price: Price) {}
    public func deletePrice(isin: String, date priceDate: String) {}
    public func getLatestPrice(forIsin instrumentIsin: String) -> Price? { nil }
    public func getLastInstrumentUpdateDate() -> String? { nil }
    public func getPrice(forIsin instrumentIsin: String, date targetDate: String) -> Price? { nil }
    public func getPriceHistory(forIsin instrumentIsin: String) -> [Price] { [] }
    public func getPriceOnOrBefore(forIsin instrumentIsin: String, date targetDate: String, windowDays: Int = 30) -> Price? { nil }
    public func getPriceBefore(forIsin instrumentIsin: String, date targetDate: String) -> Price? { nil }
    
    public func addExchangeRate(_ exchangeRate: ExchangeRate) {}
    public func getLatestRate(from: String, to: String) -> ExchangeRate? { nil }
    public func getRateOnOrBefore(from: String, to: String, date targetDate: String) -> ExchangeRate? { nil }
    
    public func getAllQuadrants() -> [Quadrant] { [] }
    public func addQuadrant(name quadrantName: String) -> Bool { false }
    public func deleteQuadrant(id quadrantIdValue: Int) {}
    
    public func getAllBankAccounts() -> [BankAccount] { [] }
    public func addBankAccount(bank: String, account: String) -> Bool { false }
    public func deleteBankAccount(id accountIdValue: Int) {}
    
    public func getHoldings(forAccount accountIdValue: Int) -> [Holding] { [] }
    public func getAllHoldings() -> [Holding] { [] }
    public func addOrUpdateHolding(_ holding: Holding) {}
    public func updateHolding(accountIdValue: Int, instrumentIsin: String, quantity newQuantity: Double, purchaseDate newPurchaseDate: String?, purchasePrice newPurchasePrice: Double?) {}
    public func deleteHolding(accountIdValue: Int, instrumentIsin: String) {}
    public func getTotalQuantity(forIsin instrumentIsin: String) -> Double { 0 }
